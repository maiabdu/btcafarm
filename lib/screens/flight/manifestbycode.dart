...
class IssueManifestbycode extends StatefulWidget {
  final OperationsUser user;
  const IssueManifestbycode({Key? key, required this.user}) : super(key: key);

  @override
  State<IssueManifestbycode> createState() => _IssueManifestbycodeState();
}

class _IssueManifestbycodeState extends State<IssueManifestbycode> {

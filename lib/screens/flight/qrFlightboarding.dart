...
class FlightboardingQR extends StatefulWidget {
  final OperationsUser user;
  const FlightboardingQR({Key? key, required this.user}) : super(key: key);

  @override
  _FlightboardingQRState createState() => _FlightboardingQRState();
}

class _FlightboardingQRState extends State<FlightboardingQR> {
            ...
            children: [
              ...
              Text(
                barcode != null
                    ...
                    : 'SCAN PILGRIM QR Code to Start Flight boarding',
                maxLines: 3,

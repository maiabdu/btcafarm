...
class ManifestQR extends StatefulWidget {
  final OperationsUser user;
  const ManifestQR({Key? key, required this.user}) : super(key: key);

  @override
  _ManifestQRState createState() => _ManifestQRState();
}

class _ManifestQRState extends State<ManifestQR> {
            ...
            children: [
              ...
              Text(
                barcode != null
                    ...
                    : 'SCAN PILGRIM QR Code to Issue Flight Manifest',
                maxLines: 3,
                      ...
                      children: [
                        InkWell(
                          onTap: () async {
                            ...
                            bool ispushed = await issueManifest(
                          ...
                          child: Material(
                            ...
                            child: Padding(
                              ...
                              child: ListTile(
                                ...
                                title: Text('Issue Flight Manifest '),
                              ),
                            ),
                          ),
                        ),

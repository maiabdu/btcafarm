...
class IssueBTAbyCode extends StatefulWidget {
  final OperationsUser user;
  const IssueBTAbyCode({Key? key, required this.user}) : super(key: key);

  @override
  State<IssueBTAbyCode> createState() => _IssueBTAbyCodeState();
}

class _IssueBTAbyCodeState extends State<IssueBTAbyCode> {

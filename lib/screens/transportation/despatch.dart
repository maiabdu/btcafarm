...
class TransportOperations extends StatefulWidget {
  final OperationsUser user;
  final String distination, bus_id;
  ...
  @override
  _TransportOperationsState createState() => _TransportOperationsState();
}

class _TransportOperationsState extends State<TransportOperations> {
          ...
          child: Column(
            children: [
                ...
                children: [
                  ...
                  Text(
                    barcode != null
                        ...
                        : 'SCAN PILGRIM To Dispatch ' + widget.distination,
                    maxLines: 3,
              ...
              InkWell(
                onTap: () {},
                child: const Text(
                  'Continue with Pilgrims PASSPORT NO',
  ...
  void onQRViewCreated(QRViewController controller) async {
    ...
    setState(() {
      ...
      controller.scannedDataStream.listen((barcode) => setState(() async {
            ...
            var pil = await pilgrimminfo(result, context);
                      ...
                      children: [
                        InkWell(
                          onTap: () async {
                            ...
                            var ispushed = await addpilgrimtobus(
                                widget.bus_id,
                                widget.distination,
                            ...
                            debugPrint('result' + ispushed.toString());

                            // debugPrint(ispushed.runtimeType);
